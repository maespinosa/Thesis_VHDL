...
next_state_comb: process(current_state,i_exp_ready,i_inbuff_valid,i_inbuff_empty,element_counter,i_num_elements,i_exp_done,i_summing_complete,i_divsion_complete) 
begin 
  exp_fifo_select <= '0'; 
  controller_ready <= '0'; 
  exp_complete <= '0'; 
  ...
  clear_all <= '0'; 
    ...
    controller_ready <= '1'; 
    exp_fifo_select <= '0'; 
    if(i_exp_ready = '1' and i_inbuff_empty = '0') then 
      next_state <= CALC_EXP; 
    else 
      next_state <= IDLE; 
    end if; 
    ...
    controller_ready <= '1';
    exp_fifo_select <= '0'; 
    if(i_inbuff_empty = '0' and i_exp_ready = '1') then 
      controller_ready <= '1';
