...
#
# Generated by export_simulation on Tue Oct 02 00:48:35 -0700 2018
#
################################################################################
...
switch to the './sim_conv_test.sh' script.

./sim_conv_test.sh -reset_run
...
./sim_conv_test.sh -noclean_files

For more information on the script, please type './sim_conv_test.sh -help'.
