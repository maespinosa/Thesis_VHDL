...
#
# Generated by export_simulation on Wed Oct 03 01:04:06 -0700 2018
#
################################################################################
...
switch to the './sim_smax_test.sh' script.

./sim_smax_test.sh -reset_run
...
./sim_smax_test.sh -noclean_files

For more information on the script, please type './sim_smax_test.sh -help'.
