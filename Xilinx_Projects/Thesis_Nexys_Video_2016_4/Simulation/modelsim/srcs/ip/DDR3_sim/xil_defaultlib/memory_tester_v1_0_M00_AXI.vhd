...
architecture implementation of memory_tester_v1_0_M00_AXI is
	...
	constant c_iterations : integer:= 2097152; 
...
begin
	...
	next_state_comb: process(current_state,i_init_calib_complete,i_trigger,axi_wvalid, iteration_counter,axi_awlen,M_AXI_RVALID,M_AXI_ARREADY,M_AXI_RLAST,M_AXI_AWREADY,M_AXI_WREADY,M_AXI_BVALID, write_beat_counter) is 
	begin 
		axi_rready <= '0'; 
		axi_bready <= '0'; 
		...
		case current_state is 
            ...
            when WRITE_RESPONSE => 
				...
				if(M_AXI_BVALID = '1') then 
					...
					axi_bready <= '1'; 
					if(iteration_counter < c_iterations and i_debug_en = '0') then 
						next_state <= WRITE_ADDRESS; 
					elsif(iteration_counter < c_iterations_sim and i_debug_en = '1') then 
						next_state <= WRITE_ADDRESS; 
					else 
	...
	begin 
		if(M_AXI_ARESETN = '0') then 
			...
			when WRITE_ADDRESS => 
				fsm_state <= "0001"; 
				axi_awaddr <= std_logic_vector(address_counter);
                axi_awsize <= "010";
                axi_awvalid <= '1'; 
				axi_awlen <= x"FF"; 
			...
			when READ_ADDRESS => 
				fsm_state <= "0100"; 
				axi_araddr <= std_logic_vector(address_counter);
				axi_arlen <= x"FF"; 
				axi_arvalid	<= '1';
				axi_arsize <= "010"; 
