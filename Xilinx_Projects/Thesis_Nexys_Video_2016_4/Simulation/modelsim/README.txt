...
#
# Generated by export_simulation on Sun Nov 11 10:40:48 -0800 2018
#
################################################################################
...
switch to the './DDR3_sim_test.sh' script.

./DDR3_sim_test.sh -reset_run
...
./DDR3_sim_test.sh -noclean_files

For more information on the script, please type './DDR3_sim_test.sh -help'.
