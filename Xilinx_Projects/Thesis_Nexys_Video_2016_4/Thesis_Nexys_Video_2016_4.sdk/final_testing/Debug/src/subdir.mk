...
src/%.o: ../src/%.c
	...
	mb-gcc -Wall -O0 -g3 -c -fmessage-length=0 -MT"$@" -I../../final_testing_bsp/microblaze_0/include -mlittle-endian -mcpu=v10.0 -mxl-soft-mul -Wl,--no-relax -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
