...
begin 
	...
	muxing: process(i_clk, i_reset_n) is 
	begin
		if(i_reset_n = '0') then 
			get_volume_row <= '0'; 
			data <= (others => '0'); 
	...
	-- muxing: process(i_new_data_en, i_prev_data_en, i_recycled_data_en,i_prev_data_wr_en,i_fifo_we,i_recycled_data_wr_en,i_new_data,i_prev_data,i_recycled_data) is 
