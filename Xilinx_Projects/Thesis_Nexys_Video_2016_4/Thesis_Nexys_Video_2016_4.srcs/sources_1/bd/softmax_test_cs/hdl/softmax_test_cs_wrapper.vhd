...
--Command     : generate_target softmax_test_cs_wrapper.bd
--Design      : softmax_test_cs_wrapper
...
entity softmax_test_cs_wrapper is
  port (
...
end softmax_test_cs_wrapper;

architecture STRUCTURE of softmax_test_cs_wrapper is
  component softmax_test_cs is
  port (
    DDR3_dq : inout STD_LOGIC_VECTOR ( 15 downto 0 );
    DDR3_dqs_p : inout STD_LOGIC_VECTOR ( 1 downto 0 );
    DDR3_dqs_n : inout STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  end component softmax_test_cs;
begin
softmax_test_cs_i: component softmax_test_cs
     port map (
