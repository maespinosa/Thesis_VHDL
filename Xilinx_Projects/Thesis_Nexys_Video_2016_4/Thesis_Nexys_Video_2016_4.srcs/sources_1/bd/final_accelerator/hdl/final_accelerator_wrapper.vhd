...
--Date        : Sun Apr 28 01:57:37 2019
--Host        : Marks-M3800 running 64-bit Service Pack 1  (build 7601)
--Command     : generate_target final_accelerator_wrapper.bd
--Design      : final_accelerator_wrapper
...
entity final_accelerator_wrapper is
  port (
...
end final_accelerator_wrapper;

architecture STRUCTURE of final_accelerator_wrapper is
  component final_accelerator is
  port (
    uart_rtl_rxd : in STD_LOGIC;
    uart_rtl_txd : out STD_LOGIC;
    DDR3_dq : inout STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  end component final_accelerator;
begin
final_accelerator_i: component final_accelerator
     port map (
