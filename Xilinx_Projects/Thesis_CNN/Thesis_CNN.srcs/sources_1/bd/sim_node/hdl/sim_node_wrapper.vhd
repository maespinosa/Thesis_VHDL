...
--Date        : Wed May 31 17:48:39 2017
--Host        : Marks-M3800-PC running 64-bit Service Pack 1  (build 7601)
--Command     : generate_target sim_node_wrapper.bd
--Design      : sim_node_wrapper
...
end sim_node_wrapper;

architecture STRUCTURE of sim_node_wrapper is
  component sim_node is
  port (
    DDR2_dq : inout STD_LOGIC_VECTOR ( 15 downto 0 );
    DDR2_dqs_p : inout STD_LOGIC_VECTOR ( 1 downto 0 );
    DDR2_dqs_n : inout STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  end component sim_node;
begin
sim_node_i: component sim_node
     port map (
