	...
	begin 
		...
		case current_state is 
			...
			when BIAS_ADDER_HOLD => 
				...
				elsif(i_more_dsps_needed = '1' and ((filter_counter < unsigned(i_filters_in_set)-1 or filter_iteration_counter < unsigned(i_filter_iterations)-1)) and affine_en = '1') then 
					--conv_data_valid <= '1';
					next_state <= ALL_CHANNELS; 
