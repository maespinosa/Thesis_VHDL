...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto 3df59baf025946c6916b11e5965ce1e1 -m64 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot mig_7series_0 xil_defaultlib.mig_7series_0 xil_defaultlib.glbl -log elaborate.log
}
